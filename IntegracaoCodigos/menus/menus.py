...
def menu_estoque(): 
    ...
    print("|" + " " + "2.3. Listar Produtos no Estoque." + " " * 29 + "|")
    print("|" + " " + "2.4. Alterar informações de estoque." + " " * 25 + "|")
    print("|" + " " + "2.5. Deletar Produtos com Provisão 100%." + " " * 21 + "|")
    print("|" + " " + "2.6. Deletar Produto do Estoque." + " " * 29 + "|")
    print("|" + " " + "2.7. Voltar." + " " * 49 + "|")
    print("|" + " " + "2.8. Encerrar Sistema." + " " * 39 + "|")
    print("|" + " " + '-' * 60 + " " + "|")
    print("|" + " " + "=" * 60 + " " + "|")
    print()
